      ...
      integer nPhyPar
      double precision, dimension(nPhyParMax) :: Temperature_s, n_H_s, Av_s
      ...
      function get_a_reac_rate(i, y, ny)
      use CMDT
      implicit none
      integer i, ny
      ...
      if ((nRealReactants(i_reac) .EQ. 0) .OR. &
        ...
        write (*,*) 'Not written: ', strReactants(:, i_reac), strProducts(:, i_reac)
        return
      else
      ...
      function get_closest_record(key, vec, Len)
      implicit none
